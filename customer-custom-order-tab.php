                    ...
                    <div class=" container card-text row">
                        ...
                        <div class="my-2 col-md-6">
                            <div class="card border-dark mt-3" style="">
                                ...
                                <div class="card-body text-dark">
                                    <div class="card-text h6 lead">Status: <span class="h6"><?=$item['status'] ? item['status'] : "ESTIMATING" ?></span></div>
                                    <div class="card-text h6 lead">Total Price: <span class="h6"><?=$item['total_price'] ? '₱ '. $item['total_price'] : "ESTIMATING" ?></span></div>
