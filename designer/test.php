...
?>
	...
	<script type="text/javascript" src="./js/fabric.js"></script>
	 <style type="text/css">
        ...
        <!-- Section-->
        <section class="py-2">
            <div class="container px-2 px-lg-5 row">
                            ...
                            <div class="card" >
                                <div class="card-body">
                                    ...
                                    <select id="tshirttype" class="form-select form-select-sm" aria-label=".form-select-sm example">
                                        ...
                                        <option value="./img/polo_front.png">Polo Shirts</option>                                        
                            ...
                            <div align="center" class="card" style="min-height: 32px;">
                                <div class="card-body">
                                    ...
                                    <div class="input-group mb-3">
							            ...
							            <button id="add-text" class="btn btn-outline-secondary" title="Add text"><i class="bi bi-send"></i></i></button>	  
                                    </div>
                ...
                <div class="col-4 col-lg-4 col-sm-12">
                   <div class="card" style="width: 530px; height: 630px; position: relative; background-color: rgb(255, 255, 255);">
                    <div class="card-body">
	...
	<div id="myOverlay" class="overlay" style="display: block;">
        ...
        <script>
            ...
            $('#flipback').click(() => {	
                ...
                else if (valueSelect === "./img/polo_front.png") {
                    if ($(this).attr("data-original-title") == "Show Back View") {
                            $(this).attr('data-original-title', 'Show Front View');			        		       
