    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="../index.php">TRENDY THREADS APPARELTORE</a>
                ...
                <div class="container mt-3">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="tab1-tab" data-bs-toggle="tab" data-bs-target="#tab1" type="button" role="tab" aria-controls="tab1" aria-selected="true">Cloth Options</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="tab2-tab" data-bs-toggle="tab" data-bs-target="#tab2" type="button" role="tab" aria-controls="tab2" aria-selected="false">Text and Logo</button>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">

                        <div class="container card tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
                            <div class=" card-text mb-3">
                                <label for="tshirttype" class="form-label">T-Shirt Type</label>
                                <select class="form-select" id="tshirttype">
                                    <option value="img/crew_front.png" selected>Short Sleeve Shirts</option>
                        ...
                        <div class="container card tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                            <div class="card-text mb-3">
                                <div class="input-group">
                                    <input type="text" class="form-control" id="text-string" placeholder="add text here...">
                                    <button id="add-text" class="btn btn-outline-secondary" title="Add text"><i class="bi bi-share"></i></button>
                                </div>
                                <hr>
                                <div id="avatarlist">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <button type="submit" class="btn btn-primary" name="submit">Upload Custom Image</button>
                                </form>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-center" style="min-height: 32px;">
                        <div class="clearfix">
                            <div class="btn-group me-2" id="texteditor" style="display:none">
                                <button class="btn btn-primary dropdown-toggle" type="button" id="font-family" data-bs-toggle="dropdown" aria-expanded="false">
                                    Font Style
                                </button>
                                <ul class="dropdown-menu" aria-labelledby="font-family">
                                    <!-- Add your font options here -->
                                    <li><a class="dropdown-item Arial" href="#" onclick="setFont('Arial');">Arial</a></li>
                                    <li><a class="dropdown-item Helvetica" href="#" onclick="setFont('Helvetica');">Helvetica</a></li>
                                    <li><a class="dropdown-item MyriadPro" href="#" onclick="setFont('Myriad Pro');">Myriad Pro</a></li>
                                    <li><a class="dropdown-item Delicious" href="#" onclick="setFont('Delicious');">Delicious</a></li>
                                    <li><a class="dropdown-item Verdana" href="#" onclick="setFont('Verdana');">Verdana</a></li>
                                    <li><a class="dropdown-item Georgia" href="#" onclick="setFont('Georgia');">Georgia</a></li>
                                    <li><a class="dropdown-item Courier" href="#" onclick="setFont('Courier');">Courier</a></li>
                                    <li><a class="dropdown-item ComicSansMS" href="#" onclick="setFont('Comic Sans MS');">Comic Sans MS</a></li>
                                    <li><a class="dropdown-item Courier" href="#" onclick="setFont('Courier');">Courier</a></li>
                                    <li><a class="dropdown-item Impact" href="#" onclick="setFont('Impact');">Impact</a></li>
                                    <li><a class="dropdown-item Monaco" href="#" onclick="setFont('Monaco');">Monaco</a></li>
                                    <li><a class="dropdown-item Optima" href="#" onclick="setFont('Optima');">Optima</a></li>
                                    <li><a class="dropdown-item HoeflerText" href="#" onclick="setFont('Hoefler Text');">Hoefler Text</a></li>
                                    <li><a class="dropdown-item Plaster" href="#" onclick="setFont('Plaster');">Plaster</a></li>
                                    <li><a class="dropdown-item Engagement" href="#" onclick="setFont('Engagement');">Engagement</a></li>
                                </ul>

                                <!-- <button class="btn btn-secondary" id="text-bold" title="Bold">B</button> -->
                                <button id="text-bold" class="btn btn-primary" data-original-title="Bold">
                                    <i class="bi bi-type-bold" style="height:19px;"></i>
                                </button>
                                <button id="text-italic" class="btn btn-primary" data-original-title="Italic">
                                    <i class="bi bi-type-italic"style="height:19px;"></i>
                                </button>
                                <button id="text-strike" class="btn btn-primary" title="Strike" style="">
                                    <i class="bi bi-type-strikethrough"></i>
                                </button>
                                <button id="text-underline" class="btn btn-primary" title="Underline" style="">
                            ...
                            <div class="btn-group me-2" id="imageeditor" style="display:none">
                                <!-- Add your image editing buttons here -->
                                <button class="btn btn-primary" id="bring-to-front" title="Bring to Front">
                                    <i class="bi bi-arrow-up-circle-fill" style="height:19px;"></i>
                                </button>
                                <button class="btn btn-primary" id="send-to-back" title="Send to Back">
                                    <i class="bi bi-arrow-down-circle-fill" style="height:19px;"></i>
                                </button>
                                <button id="flip" type="button" class="btn btn-primary" title="Show Back View">
                                    <i class="bi bi-repeat"  style="height:19px;"></i>
                                </button>
                                <button id="remove-selected" class="btn btn-primary" title="Delete selected item">
                                    <i class="bi bi-trash3-fill"style="height:19px;"></i>
                                </button>
                                <!-- ... -->
                            </div>
                        </div>
